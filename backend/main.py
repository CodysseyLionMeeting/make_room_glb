...
async def generate_tile(request: GenerateTileRequest):
    ...
    try:
        ...
        # Prepare Stable Diffusion XL request
        ...
        request_body = {
            ...
            "cfg_scale": 10,  # How strictly to follow the prompt
            "steps": 50,  # Number of diffusion steps
            "width": 512,  # Generate at 512x512 first
            "height": 512,
        }
        ...
        # Call AWS Bedrock Stable Diffusion XL
        print(f"[DEBUG] Calling Bedrock Stable Diffusion XL...")
